...
import IndividualPokemon from "./components/pokemon/IndividualPokemon";
...
function App() {
  ...
  const getUserByIdSuccess = (data) => {
    ...
    _logger(getUserByIdSuccess, data.item)
    setCurrentUser((prevstate) => {
  ...
  return (
    <React.Fragment>
      ...
      <Routes>
        ...
        <Route path="/techcompanies/:techcompanyId" element={<AddTechCo />}></Route>
        <Route path="/us/pokedex" element={<Pokedex />}></Route>
        <Route path="/us/pokedex/:name" element={<IndividualPokemon />}></Route>
        <Route path="us/pokedex/add" element={<AddPokemon />}></Route>
